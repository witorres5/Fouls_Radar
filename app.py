...
filtered_df, selected_season, selected_league = render_sidebar(raw_df)
...
render_upcoming_matches(selected_league, selected_season, filtered_df, client)

# 5. Pestañas de Análisis Predictivo y Métricas
render_analysis_tabs(filtered_df, selected_league)