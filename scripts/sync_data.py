...
def run_full_sync():
    try:
        # Si ejecutamos en local usa local.db, si estamos en GitHub Actions usará las variables de entorno
        ...
        logging.info("🎉 ¡Sincronización global completada con éxito!")
